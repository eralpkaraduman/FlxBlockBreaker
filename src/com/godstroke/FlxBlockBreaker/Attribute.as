	...
	public class Attribute extends FlxSprite
	{
		...
		public function Attribute(X:int=0, Y:int=0)
		{
			...
			attributeArray=[
				...
				new AttributeType(1/8,20,false,"frost","add_frost",0)
			];
			
			choose();
			var bad_color:Number = 0x55ff0000;
			var good_color:Number = 0x5500ff00;
			createGraphic(15,5,type.good?good_color:bad_color);
		...
		private function choose():void{
			...
			throw new Error(String("WARNING sum of drop chances is not 1 !  leaks: "+(sumOfProbs-1)),1);
			if(sumOfProbs!=1){
